...
- [ ] Разобраться с APC spawn point, в котором заданы взаимоисключающие labels: сейчас проблема визуально обозначается только отсутствием сферы и Bounding Box; добавить текстовое сообщение о конфликте labels.
